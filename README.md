...
- maa自动战斗
  ...
  2. 打关卡时，按照如下规则把”操作“记录下来
     ...
     - 角色从左到右编号为1-6，技能从上到下编号为1-3，”开始行动“为7，OD条为8

     - ”操作“有如下几种（实际上就是你的点击顺序）

       - 换位：例如数字”15“表示1号位和5号位换位，数字”62“表示6号位和2号位换位
       - 释放技能：例如”23“表示2号位放3号技能，”31“表示3号位放1技能
       - 释放技能给另一个角色：例如”113“表示1号位放1技能目标是3号角色
       - 单击：例如”7“表示点击开始行动，”8“表示释放OD
       - 注意，实际记录数字时不需要加双引号

     - 每个”操作“之间用英文逗号隔开，每轮操作结束加一个英文分号

     - 示例：7;7;7;14,114,314,7;34,113,26,21,32,7;15,11,7;41,12,21,7,8;113,25,213,32,7;
